...
define('LOGOUT_URL', 'http://www.powerswitch-entertainment.de/fewo/');
...
<html>
<head>
  <title>Bitte geben Sie das Passwort ein</title>
...
<body>
  ...
  <form method="post">
    <h3>Bitte geben Sie das Passwort ein</h3>
...
if (isset($_POST['access_password'])) {
  ...
  || (USE_USERNAME && ( !array_key_exists($login, $LOGIN_INFORMATION) || $LOGIN_INFORMATION[$login] != $pass ) ) 
    ...
    showLoginPasswordProtect("Ungueltiges Passwort.");
  }
  else {
